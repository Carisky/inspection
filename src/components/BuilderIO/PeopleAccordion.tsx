...
const PeopleAccordion: React.FC<PeopleAccordionProps> = ({
  ...
  const mergedHeaderTranslations = { ...defaultHeaderTranslations, ...headerTranslations };
      ...
      <AccordionDetails>
        <Grid container spacing={2}>
          {peopleData.map((person, index) => {
            ...
            const positionText =
              mergedPositionTranslations[locale as keyof typeof mergedPositionTranslations] ||
